...
class TaskController extends AbstractController
{
    ...
    public function create($id, $key, Request $request, ManagerRegistry $doctrine, EventDispatcherInterface $eventDispatcher)
    {
        /** Project $project */
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $eventDispatcher->dispatch(new TaskCreatedEvent($task), TaskCreatedEvent::NAME);
